        ...
        <div>
            <div className='flex justify-between px-5 mt-20 '>
                <div className='mx-auto'>
                    <h3 className='text-[#6350f2] font-bold text-xl mb-4 text-center'>Testimonial</h3>
            ...
            <div  data-aos="fade-right" data-aos-duration="3000" className='grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-20   md:p-5 sm:p-0'>
